...
\begin{enumerate}
    ...
    \item Среднее арифметическое любых двух чисел больше их среднего геометрического (не используйте операции деления и извлечения корня, так как они не везде определены).
