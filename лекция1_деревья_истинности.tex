...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Отсюда следует полнота, так как алгоритм построения дерева всегда заканчивается за конечное число шагов.
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \pause
        \item Так как $\mathcal{B}$ открыта, можем определить оценку 
